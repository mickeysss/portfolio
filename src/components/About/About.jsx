        ...
        <div className={styles.container}>
            ...
            <div className={styles.titleBlock}>
                ...
                <p>
                    <h2>Образование:</h2> 
                    <ul>
                    <li>Бакалавр. РГЭУ(РИНХ) Факультет Менеджмента и Предпринимательства. Менеджменты организации</li>
                    <li>Магистр. ЮФУ (бывш. РГУ) Факультет Управления. Управление Финансами</li>
                    </ul>
                    <h2>Достижения:</h2>
                    <ul>
                    <li>Курс "Базовый HTML и СSS" от HTML ACADEMY</li>
                    <li>Курс "Курс по JavaScript + React - с нуля до результата" от Udemy</li>
